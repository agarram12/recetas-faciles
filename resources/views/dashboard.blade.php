    ...
    <div class="row mb-5 align-items-center bg-white p-4 rounded-4 shadow-sm border-0">
        ...
        <div class="col">
            ...
            <div class="mt-2 d-flex gap-2 align-items-center">
                <a href="{{ route('usuario.seguidores', Auth::user()->id) }}" class="badge bg-success bg-opacity-10 text-success rounded-pill px-3 py-2 text-decoration-none">Seguidores: {{ Auth::user()->seguidores()->count() }}</a>
