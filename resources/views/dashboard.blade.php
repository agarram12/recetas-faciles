    ...
    <div class="row mb-5 align-items-center bg-white p-4 rounded-4 shadow-sm border-0">
        ...
        <div class="col">
            ...
            <div class="mt-2 d-flex gap-2 align-items-center">
                <a href="{{ route('usuario.seguidores', Auth::user()->id) }}" class="badge rounded-pill px-3 py-2 text-decoration-none text-white" style="background-color: #729c48;">Seguidores: {{ Auth::user()->seguidores()->count() }}</a>
                <a href="{{ route('usuario.seguidos', Auth::user()->id) }}" class="badge bg-secondary bg-opacity-10 text-secondary rounded-pill px-3 py-2 text-decoration-none">Siguiendo: {{ Auth::user()->seguidos()->count() }}</a>
            </div>
        </div>
        <div class="col-auto">
